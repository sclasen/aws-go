...
type ClusterTimeline struct {
	CreationDateTime aws.UnixTimestampValue `json:"CreationDateTime,omitempty"`
	EndDateTime      aws.UnixTimestampValue `json:"EndDateTime,omitempty"`
	ReadyDateTime    aws.UnixTimestampValue `json:"ReadyDateTime,omitempty"`
}
...
type DescribeJobFlowsInput struct {
	CreatedAfter  aws.UnixTimestampValue `json:"CreatedAfter,omitempty"`
	CreatedBefore aws.UnixTimestampValue `json:"CreatedBefore,omitempty"`
...
type InstanceGroupDetail struct {
	BidPrice              aws.StringValue        `json:"BidPrice,omitempty"`
	CreationDateTime      aws.UnixTimestampValue `json:"CreationDateTime"`
	EndDateTime           aws.UnixTimestampValue `json:"EndDateTime,omitempty"`
	...
	Name                  aws.StringValue        `json:"Name,omitempty"`
	ReadyDateTime         aws.UnixTimestampValue `json:"ReadyDateTime,omitempty"`
	StartDateTime         aws.UnixTimestampValue `json:"StartDateTime,omitempty"`
